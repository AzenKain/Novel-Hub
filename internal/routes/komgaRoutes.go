...
// The Mihon Komga extension appends /api/v1 itself and only attaches Basic credentials after a 401 (its OkHttp authenticator is challenge-driven), so returning 403 here breaks auth entirely.
