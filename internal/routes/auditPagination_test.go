...
// TestAuditBooksPaginationEnvelopeUnified confirms the backend and frontend agree on the top-level next_cursor.
...
// TestAuditBooksServiceUsesCursorPaginatedResponse confirms the service path that feeds the frontend builds the top-level next_cursor response.
