...
// TestAuditMagicCodeActivationAutoFillsFromURL proves task T1.2: the magic code activation page (web/src/pages/auth/ActivateMagicCodePage.tsx) reads the 6-digit code straight from the URL query param (?code=) and auto-fills it into the activation form.
