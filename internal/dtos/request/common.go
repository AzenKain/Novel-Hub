...
// No validate tags: OPDS parses its query string by hand rather than through pkg/validator, because a reader device gets an XML error document, not a JSON field-error list.
