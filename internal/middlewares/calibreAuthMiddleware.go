...
func CalibreAuth(authService services.AuthService, settingsService services.SettingsService, userRepo ...repositories.UserRepository) fiber.Handler {
	...
	return func(c fiber.Ctx) error {
		...
		if strings.HasPrefix(authHeader, "Basic ") {
			...
			c.Set("WWW-Authenticate", `Basic realm="NovelHub Calibre Server"`)
