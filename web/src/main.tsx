...
const Books = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.Books })),
);
const Duplicates = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.Duplicates })),
);
const OAuthSettings = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.OAuthSettings })),
);
const Operations = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.Operations })),
);
const Reviews = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.Reviews })),
);
const Roles = lazy(() =>
...
const Users = lazy(() =>
  import("@/pages/admin").then((m) => ({ default: m.Users })),
);
...
const SetupWizard = lazy(() =>
  import("@/pages/auth").then((m) => ({ default: m.SetupWizard })),
);
const ActivateMagicCodePage = lazy(() =>
  import("@/pages/auth/ActivateMagicCodePage").then((m) => ({
    default: m.ActivateMagicCodePage,
  })),
);
const LibraryWorkspace = lazy(() =>
  import("@/pages/library").then((m) => ({ default: m.LibraryWorkspace })),
);
const ReadListPage = lazy(() =>
  import("@/pages/library").then((m) => ({ default: m.ReadListPage })),
);
const AdvancedSearchPage = lazy(() =>
  import("@/pages/library/AdvancedSearchPage").then((m) => ({
    default: m.AdvancedSearchPage,
  })),
);
const PodcastsPage = lazy(() =>
  import("@/pages/podcasts/PodcastsPage").then((m) => ({
    default: m.PodcastsPage,
  })),
);
const ReaderWorkspace = lazy(() =>
  import("@/pages/reader").then((m) => ({ default: m.ReaderWorkspace })),
);
const ReadingAnalyticsPage = lazy(() =>
  import("@/pages/user/ReadingAnalyticsPage").then((m) => ({
    default: m.ReadingAnalyticsPage,
  })),
);
const OfflineBooksPage = lazy(() =>
  import("@/pages/user/OfflineBooksPage").then((m) => ({
    default: m.OfflineBooksPage,
  })),
);
        ...
        <SetupGuard>
          ...
          >
            <Routes>
              ...
              <Route
                path="/offline/reader/:book_id"
                element={<ReaderWorkspace />}
              />
              <Route element={<GuestGuard />}>
                ...
                <Route
                  element={
                    <ProtectedRoute requiredPermission="podcast.manage" />
                  }
                >
                ...
                <Route
                  element={
                    <ProtectedRoute requiredPermission="user.stats.read" />
                  }
                >
                ...
                >
                  <Route element={<AdminLayout />}>
                    ...
                    <Route
                      element={
                        <ProtectedRoute requiredPermission="book.duplicate.manage" />
                      }
                    >
                    ...
                    <Route
                      element={
                        <ProtectedRoute requiredPermission="book.review.delete" />
                      }
                    >
