export const POLICY_MODES = [
  ...
  {
    value: "selected_libraries",
    labelKey: "settings.policy_mode_selected_libraries",
  },
];
...
export const GUEST_MODES = [
  ...
  {
    value: "selected_libraries",
    labelKey: "settings.guest_mode_selected_libraries",
  },
];
...
export function getSideTapRatio(screenWidth: number): number {
  ...
  return Number((factor * 0.3).toFixed(3));
}
