            ...
            {uploading ? (
              ...
              >
                <label className="flex flex-col items-center justify-center gap-3 w-full cursor-pointer">
                  ...
                  />
                  <div
                    className={`p-3 rounded-2xl transition-colors ${isDragging ? "bg-primary text-primary-content" : "bg-primary/10 text-primary"}`}
                  >
                    <Upload size={28} />
                  </div>
