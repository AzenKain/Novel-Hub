          ...
          >
            ...
            {sideWidthPercent > 0 && (
              <div
                ...
                title={
                  isRtl
                    ? isLastPage && canGoNextChapter
                      ? t("reader.next_chapter", "Next Chapter")
                      : t("reader.next_page", "Next Page")
                    : currentPage <= 0 && canGoPrevChapter
                      ? t("reader.prev_chapter", "Previous Chapter")
                      : t("reader.prev_page", "Previous Page")
                }
              >
            ...
            <div
              onClick={(e) => {
                ...
                const targetPageIdx =
                  isDouble && isRightSide && imageUrls[rightPageIdx]
                    ? rightPageIdx
                    : leftPageIdx;
                if (imageUrls[targetPageIdx]) {
                  onImageClick?.({
