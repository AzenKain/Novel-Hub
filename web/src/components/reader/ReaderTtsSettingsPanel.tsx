...
export const ReaderTtsSettingsPanel: React.FC<ReaderTtsSettingsPanelProps> = ({
  ...
  return (
    <div className="reader-settings-panel absolute right-0 top-full z-50 mt-2 max-h-[80dvh] w-[80vw] max-w-[80vw] sm:w-96 sm:max-w-md overflow-y-auto rounded-2xl border p-3.5 sm:p-4 shadow-2xl space-y-4 animate-in fade-in duration-150 backdrop-blur-md">
