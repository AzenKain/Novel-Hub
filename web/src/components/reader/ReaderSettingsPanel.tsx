...
export const ReaderSettingsPanel: React.FC<ReaderSettingsPanelProps> = ({
  ...
  if (isVisualContent) {
    return (
      <div className="reader-settings-panel absolute right-0 top-full z-50 mt-2 max-h-[80dvh] w-[80vw] max-w-[80vw] sm:w-96 md:w-[440px] sm:max-w-md overflow-y-auto rounded-2xl border p-3.5 sm:p-5 shadow-2xl transition-colors duration-300">
