    ...
    <div className="flex flex-col h-full bg-base-100 font-sans">
      ...
      <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto w-full space-y-3.5">
          <div
            role="tablist"
            className="flex items-center gap-1.5 bg-base-200/50 p-1.5 rounded-2xl border border-base-200 w-fit flex-wrap"
          >
            {tabs.map((tab) => {
              const Icon = tab.icon;
          ...
          {active === "schedules" && (canReadJobs || canManageJobs) && (
            <SchedulesTab />
          )}
