...
export function Settings() {
  ...
  const {
    ...
    setHardcoverEnabled,
    hardcoverClientId,
    setHardcoverClientId,
    hardcoverClientSecret,
    setHardcoverClientSecret,
    autoEnrich,
    setAutoEnrich,
    webpCover,
    setWebpCover,
    ...
    useShallow((state) => ({
      ...
      setSidebarItems: state.setSidebarItems,
      homeSections: state.homeSections,
      setHomeSections: state.setHomeSections,
      registration: state.registration,
      setRegistration: state.setRegistration,
      loginRequired: state.loginRequired,
      setLoginRequired: state.setLoginRequired,
      requireEmailVerify: state.requireEmailVerify,
      setRequireEmailVerify: state.setRequireEmailVerify,
      passwordResetEnabled: state.passwordResetEnabled,
      setPasswordResetEnabled: state.setPasswordResetEnabled,
      guestMode: state.guestMode,
      setGuestMode: state.setGuestMode,
      guestLibraryIds: state.guestLibraryIds,
      setGuestLibraryIds: state.setGuestLibraryIds,
      inBookSearch: state.inBookSearch,
      setInBookSearch: state.setInBookSearch,
      customFontUpload: state.customFontUpload,
      setCustomFontUpload: state.setCustomFontUpload,
      anilistTracking: state.anilistTracking,
      setAnilistTracking: state.setAnilistTracking,
      hardcoverEnabled: state.hardcoverEnabled,
      setHardcoverEnabled: state.setHardcoverEnabled,
      hardcoverClientId: state.hardcoverClientId,
      setHardcoverClientId: state.setHardcoverClientId,
      hardcoverClientSecret: state.hardcoverClientSecret,
      setHardcoverClientSecret: state.setHardcoverClientSecret,
      autoEnrich: state.autoEnrich,
      setAutoEnrich: state.setAutoEnrich,
      webpCover: state.webpCover,
      setWebpCover: state.setWebpCover,
      savingSection: state.savingSection,
      setSavingSection: state.setSavingSection,
      uploadingLogo: state.uploadingLogo,
      setUploadingLogo: state.setUploadingLogo,
      uploadingFavicon: state.uploadingFavicon,
      setUploadingFavicon: state.setUploadingFavicon,
      selectedCropImage: state.selectedCropImage,
      setSelectedCropImage: state.setSelectedCropImage,
      cropTarget: state.cropTarget,
      setCropTarget: state.setCropTarget,
      initFromSettings: state.initFromSettings,
      proxyAuth: state.proxyAuth,
      setProxyAuth: state.setProxyAuth,
    })),
  );
  ...
  function handleReaderFeaturesSave() {
    void saveSection("Reader features", {
      ...
      ...(hardcoverClientSecret.trim()
        ? { "hardcover.client_secret": hardcoverClientSecret.trim() }
        : {}),
    });
  }
  ...
  function handleRegistrationSave() {
    void saveSection("Registration & Guest", {
      ...
      "guest_access.library_ids":
        guestMode === "selected_libraries" ? guestLibraryIds : [],
    });
  }
          ...
          <div className="card bg-base-100 border border-base-200 shadow-sm">
            <div className="card-body p-4 sm:p-5">
              <form onSubmit={handleSiteSave} className="flex flex-col gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <h2 className="card-title text-lg">
                        {t("settings.site_info", "Site Information")}
                      </h2>
                    </div>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.site_info_desc",
                        "Customize how your library appears to visitors.",
                      )}
                    </p>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      value={site.title}
                      onChange={(e) =>
                        setSite({ ...site, title: e.target.value })
                      }
                    />
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                      {t("settings.meta_desc_label", "Meta Description")}
                    </label>
                    <input
                      type="text"
                      className="input input-bordered w-full"
                      ...
                      onChange={(e) =>
                        setSite({ ...site, meta_description: e.target.value })
                      }
                    />
                  </div>
                  <div className="flex flex-col gap-1.5 col-span-1 sm:col-span-2">
                    <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                      {t("settings.server_url_label", "Server URL")}
                    </label>
                    <input
                      type="text"
                      className="input input-bordered w-full"
                    ...
                    <p className="text-xs text-base-content/50 pl-1">
                      {t(
                        "settings.server_url_desc",
                        "Absolute base URL used in OPDS catalog and Kobo sync links. Leave empty to detect it from each request — set it only if the detected host is wrong, for example behind a path-rewriting proxy.",
                      )}
                    </p>
                  </div>
                  <div className="flex flex-col gap-1.5 col-span-1 sm:col-span-2">
                    <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                      {t("settings.logo_url_label", "Logo URL")}
                    </label>
                      ...
                      <div className="flex flex-col gap-2 flex-1">
                        <div className="join w-full">
                          <input
                            ...
                            value={site.logo}
                            onChange={(e) =>
                              setSite({ ...site, logo: e.target.value })
                            }
                            placeholder="https://..."
                          />
                          <button
                            ...
                            disabled={
                              !site.logo.startsWith("http") || uploadingLogo
                            }
                          >
                            {uploadingLogo ? (
                              <Loader2 className="w-4 h-4 animate-spin" />
                            ) : (
                              t("settings.fetch", "Fetch")
                            )}
                          </button>
                        </div>
                  ...
                  <div className="flex flex-col gap-1.5 col-span-1 sm:col-span-2">
                    <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                      {t("settings.favicon_url_label", "Favicon URL")}
                    </label>
                    <div className="flex gap-2 items-start">
                      <div className="flex flex-col gap-2 flex-1">
                        <div className="join w-full">
                          <input
                            ...
                            value={site.favicon}
                            onChange={(e) =>
                              setSite({ ...site, favicon: e.target.value })
                            }
                            placeholder="https://..."
                          />
                          <button
                      ...
                      <div className="w-12 h-12 rounded-lg bg-base-200 border border-base-300 flex items-center justify-center overflow-hidden shrink-0">
                        ...
                        <div
                          className={`w-5 h-5 bg-base-300 rounded opacity-40 ${site.favicon ? "hidden" : ""}`}
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                    {t("settings.description_label", "Description")}
                  </label>
                  <textarea
          ...
          <div className="card bg-base-100 border border-base-200 shadow-sm">
            <div className="card-body p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h2 className="card-title text-lg">
                      {t("settings.sidebar_nav", "Sidebar Navigation")}
                    </h2>
                  </div>
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.sidebar_nav_desc",
                      "Choose which navigation items appear in the library sidebar.",
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                {(adminSettings?.available_sidebar_items || []).map(
                  (key: string) => (
                    <label
                      key={key}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h2 className="card-title text-lg">
                      {t("settings.home_sections", "Home Page Sections")}
                    </h2>
                  </div>
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.home_sections_desc",
                      "Enable or disable sections on the library home page.",
                    )}
                  </p>
                </div>
                <button
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  <input
                    ...
                    onChange={(e) =>
                      setHomeSections({
                        ...homeSections,
                        random_books: e.target.checked,
                      })
                    }
                  />
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.random_books", "Random Books")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.random_books_desc",
                        "Show random books section on the home page.",
                      )}
                    </p>
                  </div>
                </label>
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  <input
                    ...
                    onChange={(e) =>
                      setHomeSections({
                        ...homeSections,
                        top_books: e.target.checked,
                      })
                    }
                  />
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.top_books", "Top Books")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.top_books_desc",
                        "Show top rated / most read books section.",
                      )}
                    </p>
                  </div>
                </label>
            ...
            <div className="card-body p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    <Layout className="h-5 w-5 text-primary" />
                    <h2 className="card-title text-lg">
                      {t("settings.reader_features", "Reader Features & Fonts")}
                    </h2>
                  </div>
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.reader_features_desc",
                      "Toggle advanced reader search and server font uploads.",
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-col gap-2.5">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.in_book_search", "Enable In-Book Search")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.in_book_search_desc",
                        "Allow readers to search text inside open books (On-demand disk scan).",
                      )}
                    </p>
                  </div>
                </label>
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t(
                        "settings.custom_font_upload",
                        "Enable Server Custom Font Uploads",
                      )}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.custom_font_upload_desc",
                        "Allow authorized users to upload custom fonts to server (default is local IndexedDB font storage).",
                      )}
                    </p>
                  </div>
                </label>
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t(
                        "settings.anilist_tracking",
                        "Enable AniList Tracking",
                      )}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.anilist_tracking_desc",
                        "Allow users to connect AniList and sync reading progress.",
                      )}
                    </p>
                  </div>
                </label>
                ...
                <div className="p-3 bg-base-200/50 rounded-lg space-y-3">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                      <span className="text-sm font-medium">
                        {t(
                          "settings.hardcover_tracking",
                          "Enable Hardcover Scrobbling",
                        )}
                      </span>
                      <p className="text-xs text-base-content/50">
                        {t(
                          "settings.hardcover_tracking_desc",
                          "Allow users to connect Hardcover and sync reading progress. Requires a Hardcover developer app (OAuth client ID & secret).",
                        )}
                      </p>
                    </div>
                  </label>
                  <div className="grid gap-2 sm:grid-cols-2">
                    <label className="block">
                      <span className="text-xs font-bold uppercase tracking-wider text-base-content/70">
                        {t("settings.hardcover_client_id", "Client ID")}
                      </span>
                      <input
                        type="text"
                    ...
                    <label className="block">
                      <span className="text-xs font-bold uppercase tracking-wider text-base-content/70">
                        {t("settings.hardcover_client_secret", "Client Secret")}
                      </span>
                      <input
                        type="password"
                        className="input input-bordered input-sm w-full mt-1"
                        ...
                        onChange={(e) =>
                          setHardcoverClientSecret(e.target.value)
                        }
                        placeholder={t(
                          "settings.hardcover_client_secret_placeholder",
                  ...
                  >
                    {t(
                      "settings.hardcover_dev_link",
                      "Create a Hardcover developer app ↗",
                    )}
                  </a>
                </div>
              </div>
            ...
            <div className="card-body p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h2 className="card-title text-lg">
                      {t("settings.metadata_covers", "Metadata & Covers")}
                    </h2>
                  </div>
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.metadata_covers_desc",
                      "Configure automatic metadata enrichment and cover image optimization.",
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-col gap-2.5">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.auto_enrich", "Auto-enrich Book Metadata")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.auto_enrich_desc",
                        "Automatically retrieve metadata from AniList, OpenLibrary, and Google Books APIs on book import.",
                      )}
                    </p>
                  </div>
                </label>
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.webp_cover", "Compress Covers to WebP")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.webp_cover_desc",
                        "Compress cover images to high-performance WebP format when extracting or uploading book files.",
                      )}
                    </p>
                  </div>
                </label>
            ...
            <div className="card-body p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  ...
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.registration_guest_desc",
                      "Control who can register and what guests can see.",
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-col gap-3">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.public_registration_desc",
                  ...
                  <div>
                    ...
                    <p className="text-xs text-base-content/50">
                      {adminSettings?.smtp?.enabled
                        ? t(
                            "settings.require_email_verify_desc",
                            "New accounts must confirm an emailed code before they are created.",
                          )
                        : t(
                            "settings.needs_smtp",
                            "Configure SMTP below to enable this.",
                          )}
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-base-content/50">
                      {adminSettings?.smtp?.enabled
                        ? t(
                            "settings.password_reset_enabled_desc",
                            'Shows a "Forgot password?" link and lets users reset with an emailed code.',
                          )
                        : t(
                            "settings.needs_smtp",
                            "Configure SMTP below to enable this.",
                ...
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm font-medium">
                      {t("settings.login_required", "Require Login")}
                    </span>
                    <p className="text-xs text-base-content/50">
                      {t(
                        "settings.login_required_desc",
                        "Force all users to sign in to access any content.",
                      )}
                    </p>
                  </div>
                </label>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1 flex items-center gap-1">
                    ...
                    {t("settings.guest_mode", "Guest Access Mode")}
                  </label>
                  <select
                ...
                {guestMode === "selected_libraries" && (
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider opacity-60 pl-1">
                      {t("settings.allowed_libraries", "Allowed Libraries")}
                    </label>
                    <LibraryMultiSelect
                      ids={guestLibraryIds}
                      libraries={libraries}
            ...
            <div className="card-body p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                <div>
                  ...
                  <p className="text-xs text-base-content/50">
                    {t(
                      "settings.proxy_auth_desc",
                      "Authenticate users automatically via HTTP headers behind Authelia/NGINX/Caddy.",
                    )}
                  </p>
                </div>
                <button
              ...
              <div className="flex flex-col gap-4">
                <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium">
                      {t(
                        "settings.enable_proxy_auth",
                        "Enable Proxy Header Login",
                      )}
                    </span>
                    <span className="text-xs text-base-content/60">
                      {t(
                        "settings.enable_proxy_auth_desc",
                        "Trust headers from configured reverse proxies to authenticate users.",
                      )}
                    </span>
                  </div>
                </label>
                  ...
                  <>
                    <div className="flex flex-col gap-1.5">
                      ...
                      <span className="text-xs text-base-content/50 pl-1">
                        {t(
                          "settings.proxy_headers_desc",
                          "Comma-separated list of headers checked in order for user identifiers (email or username).",
                        )}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <span className="text-xs text-base-content/50 pl-1">
                        {t(
                          "settings.trusted_proxies_desc",
                          "Comma-separated list of IP addresses or subnets (CIDR) permitted to send proxy authentication headers.",
                        )}
                      </span>
                    </div>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer p-3 bg-base-200/50 rounded-lg">
                      ...
                      <div className="flex flex-col">
                        <span className="text-sm font-medium">
                          {t(
                            "settings.proxy_auto_create",
                            "Automatic User Provisioning",
                          )}
                        </span>
                        <span className="text-xs text-base-content/60">
                          {t(
                            "settings.proxy_auto_create_desc",
                            "Create a new user account with default role automatically if user does not exist in NovelHub database.",
                          )}
                        </span>
                      </div>
                    </label>
