...
- **State Management**:
  - Use Zustand stores under `web/src/stores/` (`useAuthStore`, `useThemeStore`, `useReaderSettingsStore`) for global UI state, theme, user authentication, and reader settings.
